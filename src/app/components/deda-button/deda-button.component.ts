...
@Component({
  selector: 'deda-button',
  templateUrl: './deda-button.component.html',
  styleUrls: ['./deda-button.component.css']
})
export class DedaButtonComponent {

  @Input() text: string;
  @Input() type: string;
  @Input() value: string;
  @Input() formtargetframename: string;
  @Input() formtarget: string;
  @Input() formnovalidate: string;
