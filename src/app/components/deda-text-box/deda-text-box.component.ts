...
@Component({
  selector: 'deda-text-box',
  templateUrl: './deda-text-box.component.html',
  styleUrls: ['./deda-text-box.component.css'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => DedaTextBoxComponent),
      multi: true
    }
  ]
})
export class DedaTextBoxComponent implements ControlValueAccessor {
